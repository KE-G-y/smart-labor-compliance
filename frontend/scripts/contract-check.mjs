...
const requiredApiContracts = [
  ...
  ['getVectorVersions', "api.get('/admin/vector-versions'"],
  ['activateVectorVersion', '/admin/vector-versions/${id}/activate'],
  ['archiveVectorVersion', '/admin/vector-versions/${id}/archive'],
  ['uploadVectorDocument', "api.post('/admin/vector-documents/upload'"],
]
